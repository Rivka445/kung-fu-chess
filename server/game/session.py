import asyncio
import time
from server.game.engine.game_builder import GameBuilder
from shared.model.position import from_chess_notation
from shared.model.piece import Color
from shared.events.event_bus import Capture
from shared.protocol.serializer import serialize, make_event_collector
from server.db.db import update_ratings, STARTING_RATING
